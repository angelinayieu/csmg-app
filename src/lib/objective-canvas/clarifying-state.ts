...
export interface ClarifyingQuestion {
  ...
  /** True when generated by the "researched" mode — grounded in the
   *  surface-research findings + extracted concepts rather than the
   *  objective text alone. The UI groups these under a "Researched
   *  proposals" label. */
  grounded?: boolean;
}
